...
- (Hopefully) fixed a few bugs:
  ...
  - Wendigo not splitting when the fight was reset
...
1. Go the [Latest release](https://github.com/knutwalker/ff1x-autosplitter/releases/tag/latest)

1. Download the [`ffx_autosplitter.wasm` file](https://github.com/knutwalker/ff1x-autosplitter/releases/download/latest/ffx_autosplitter.wasm) from the list of Assets
